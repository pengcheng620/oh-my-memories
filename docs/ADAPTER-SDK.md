...
Cat C (saas) is harder: rate limits, auth, network failures. Built-in adapters cover Cat A (Claude Code, Cursor, Codex, Gemini CLI, OpenCode, Aider, Copilot Chat) and Cat B (Serena, Basic Memory). We accept Cat C contributions in M2+.
