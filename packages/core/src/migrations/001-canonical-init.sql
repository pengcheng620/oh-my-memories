-- Canonical store baseline schema. See specs/m3-canonical-store-mini-spec.md §2.
--
-- Single-row schema_meta table tracks the highest applied migration. The runner
-- in packages/core/src/migrations.ts inserts the row exactly once after this
